...
begin
  ...
  Self.Colors.Mrizka := StringToColor(Self.Files.IniFile.ReadString('Colors', 'Mrizka',
    ColorToString(_Def_Color_Mrizka)));
  Self.Colors.Pozadi := StringToColor(Self.Files.IniFile.ReadString('Colors', 'Pozadi',
    ColorToString(_Def_Color_Pozadi)));
  Self.Colors.Kurzor := StringToColor(Self.Files.IniFile.ReadString('Colors', 'Kurzor',
    ColorToString(_Def_Color_Kurzor)));
  Self.Colors.KurzorOnObject := StringToColor(Self.Files.IniFile.ReadString('Colors', 'KurzorOnObject',
    ColorToString(_Def_Color_Kurzor_OnObject)));
  Self.Colors.KurzorOperation := StringToColor(Self.Files.IniFile.ReadString('Colors', 'KurzorOperation',
