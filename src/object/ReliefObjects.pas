 ...
 if (Assigned(Self.FOnMsg)) then
  begin
   case (Self.Selected.typ) of
    ...
    TBlkType.navestidlo   : Self.FOnMsg(Self, 'Blok '+IntToStr(blk)+ ' (návěstidlo '+IntToStr(Self.Selected.index)+')');
    TBlkType.vyhybka      : Self.FOnMsg(Self, 'Blok '+IntToStr(blk)+ ' (výhybka '+IntToStr(Self.Selected.index)+'), přiřazen úseku '+IntToStr((Self.Selected as TVyhybka).obj));
    TBlkType.prejezd      : Self.FOnMsg(Self, 'Blok '+IntToStr(blk)+ ' (přejezd '+IntToStr(Self.Selected.index)+')');
    ...
    TBlkType.vykol        : Self.FOnMsg(Self, 'Blok '+IntToStr(blk)+ ' (výkolejka '+IntToStr(Self.Selected.index)+'), přiřazena úseku '+IntToStr((Self.Selected as TVykol).obj));
    TBlkType.rozp         : Self.FOnMsg(Self, 'Blok '+IntToStr(blk)+ ' (rozpojovač '+IntToStr(Self.Selected.index)+')');
   end;//case
