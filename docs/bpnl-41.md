# Specifikace formátu souboru bpnl v4.1
...
Oproti předchozí verzi (v4.0) umožňuje ukládání až 65535 oddělovačů,
symbolů popisků kolejí, symbolů konců jízdních a symbolů zobrazení souprav na koleji.
Dřívě byl limit nastaven na 255 prvků.
...
Soubor se skládá z několika sekcí, každá sekce je ukončena byty `0xFF, 0xFF`
 ...
 4. Vertikální oddělovače
    Formát: 1. a 2. byte je počet oddělovačů, první byte obsahuje bity
    vyšších významu. Pak následují dvojice pozic [X, Y].
