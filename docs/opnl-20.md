# Specifikace formátu souboru opnl v2.0

*v2.0 oproti v1.3 mění význam jednotlivých symbolů a definuje pomocná stavědla.
Viz <src/rec/All8.bmp>.*
